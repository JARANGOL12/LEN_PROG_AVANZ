	...
	<div class="container mt-5">
		...
		<div class="row">
			...
			%>
				...
				<a href="/Restaurante_Peru/sucursales/<%=sucursal.getIdSucursal()%>">
                    <div class="card">
                        <img class="card-img-top" src="<%= sucursal.getImagenUrl() %>" alt="Imagen del restaurante">
                        <div class="card-body">
                            <h5 class="card-title"><%= sucursal.getNombre() %></h5>
                            <p class="card-text">Direccion: <%= sucursal.getDireccion() %></p>
                            <p class="card-text">Telefono: <%= sucursal.getTelefono() %></p>
